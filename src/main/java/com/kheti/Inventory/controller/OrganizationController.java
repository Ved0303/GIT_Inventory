...
public class OrganizationController {
	...
	public String createOrganization(@ModelAttribute Organization organization, ModelMap model,
			HttpServletRequest request, HttpSession session) {
		User user = (User) session.getAttribute("user");
		System.out.println("Organization Controller -> createOrganization");

		System.out.println("OrganizationName: " + request.getParameter("OrganizationName"));
		organization.setOwnerId(user.getOwnerId());
	...
	public String listOrganization(HttpServletRequest request, HttpSession session) {
		User user = (User) session.getAttribute("user");
		System.out.println("Organization Controller -> listOrganization");

		List<Organization> organizationList = organizationService.getAllOrganization(user.getOwnerId());
